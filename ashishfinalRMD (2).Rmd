...
- Which airline has the highest average arrival delay? Which airline has the smallest average arrival delay? Are there airlines that actually have negative average delay? Provide answer to this question in a text paragraph form using **inline R code**.
  ...
  The airline with the highest average delay can be represented by the following code: `r names(tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE')[tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE') == max(tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE'))])`
  
  The airline with the smallest average delay can be represented by the following code: 
  
  `r names(tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE')[tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE') == min(tapply(nyc$arr_delay, nyc$carrier, mean, na.rm = 'TRUE'))])`. 
  
  Viewing our barplot from previous code shows us that airlines AS and HA have negative average delays. 
